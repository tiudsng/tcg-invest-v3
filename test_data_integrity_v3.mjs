 ...
 * Run: node test_data_integrity_v3.mjs
 */
...
async function main() {
  ...
  console.log('\n  Issues found:');
  console.log('  1. Firestore needs auth (service account works server-side)');
  console.log('  2. SNKRDUNK CDN blocked from this server IP');
  console.log('  3. pokeca-chart API returns "-1" for some slugs (not in their DB)');
  console.log('\n  Browser Client: Uses Firebase client SDK (works with auth)');
  console.log('  pokeca-chart API: Works from browser (CORS allowed)');
}
