  ...
  return (
    <div className="mb-12 sm:mb-16 bg-[#0a0a0a] rounded-3xl p-4 sm:p-6 shadow-2xl overflow-hidden border border-white/5">
      <div className="space-y-4">
        {/* NO.1 Card */}
        {topCards[0] && (
          <div className="relative rounded-2xl overflow-hidden border border-[#d4af37] bg-[#111] flex flex-col shadow-[0_0_15px_rgba(212,175,55,0.15)]">
            {/* Image Section */}
            <div className="relative w-full aspect-[4/3] sm:aspect-[16/9] bg-gray-900">
              <div className="absolute top-3 left-3 z-10 text-[#d4af37] text-3xl font-black drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)] tracking-tighter">NO.1</div>
              <img 
                src={topCards[0].image_url || 'https://placehold.co/600x450/1c1c1e/888888?text=Card+Image'} 
            ...
            {/* Info Section */}
            <div className="p-4 pt-0 relative z-10 bg-[#111]">
              <div className="flex justify-between items-start gap-2 mb-2">
                <h3 className="text-white font-bold text-sm sm:text-base uppercase leading-tight">
              ...
              <div className="flex items-baseline gap-3 mb-3">
                <span className="text-[#d4af37] text-3xl font-black tracking-tight">
              ...
              <div className="text-gray-400 text-[10px] font-medium border-t border-white/10 pt-2">
        ...
        <div className="grid grid-cols-2 gap-4">
          {topCards.slice(1, 3).map((card, idx) => (
            <div key={card.id || card.card_id} className="bg-[#1c1c1e] rounded-2xl p-3 flex flex-col relative border border-transparent">
              <div className="flex justify-between items-start mb-2">
                <span className="text-gray-400 font-bold text-sm tracking-tighter">NO.{idx + 2}</span>
                <div className="bg-black text-white text-[8px] font-black px-1.5 py-0.5 rounded leading-tight text-center">SNKR<br/>DUNK</div>
              </div>
              <div className="w-full aspect-[3/4] flex items-center justify-center mb-3">
                <img 
              ...
              <div className="mt-auto">
                <h4 className="text-white text-xs font-bold truncate mb-0.5">{card.name_zh}</h4>
                ...
                >
                  <div className="pt-4 space-y-2">
                    {remainingCards.map((card) => (
                      <div key={card.id || card.card_id} className="bg-[#1c1c1e] rounded-2xl p-3 flex items-center gap-3">
